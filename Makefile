...
CFLAGS = -Wall -O2 -g -I$(FFMPEG_INC) -I$(RGA_INC) -I$(ELF2_EXT_INC) -Wl,--allow-shlib-undefined
...
clean:
	rm -f $(OBJS) $(STORE_DEBUG_OBJS) $(MQTT_CHAIN_DEBUG_OBJS) $(TARGET) $(STORE_DEBUG_TARGET) $(MQTT_CHAIN_DEBUG_TARGET)

.PHONY: all clean $(STORE_DEBUG_TARGET) $(MQTT_CHAIN_DEBUG_TARGET)
